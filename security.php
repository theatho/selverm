/* Developer ( Ibrahaim ) channel @wwwwibrahimcom */
<?php
...
⚜¦ قناة السورس @wwwwibrahimcom
⚜¦ مطور السورس @Ibrahaim
⚜¦ لتنصيب السورس إضغط على الزر ⬇️
",
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"√ • تنصيب بوت مجاني • √",'url'=>"https://telegram.me/Hmitgrbot?start"]
              ] 
              ],
        ])
            ]);
